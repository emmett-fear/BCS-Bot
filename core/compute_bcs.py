...
def drop_high_low(vals):
    ...
    # If < 6 systems posting (e.g., Wolfe early-season), just average what you have and label "5/6".
    if len(vals) < 6:
...
def main():
    ...
    systems = ["sagarin","anderson_hester","billingsley","colley","massey","wolfe"]
    comp_map = {}
    comp_used_count = { k:0 for k in systems }
    ...
    for team in teams:
        vals = [comp_map.get(team,{}).get(s) for s in systems]
